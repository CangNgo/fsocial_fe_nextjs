...
export function ProfileHeader({
  ...
  return (
    <div className="flex sm:flex-row sm:items-start flex-col justify-between items-center gap-4 sm:px-3 px-1">
      <div className="flex flex-row gap-4">
        ...
        <div className="flex-grow sm:self-center sm:block sm:px-0 sm:pt-5 px-4 flex flex-col items-center">
          <h3 className="line-clamp-2 text-2xl font-bold">{displayName ?? "Tên người dùng"}</h3>
      ...
      <div className="flex sm:flex-row flex-row self-center gap-2 sm:gap-2 sm:items-center">
        ...
        <Popover>
          ...
          >
            ...
            {!isOwner && isFollowing === true && (
              <Button
                variant="outline"
                className="btn-secondary text-nowrap h-10 w-1.5"
                onClick={onUnfollow}
              >
                Đang theo dõi
              </Button>
